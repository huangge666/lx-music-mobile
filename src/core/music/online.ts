...
export const getMusicUrl = async({ musicInfo, quality, isRefresh, allowToggleSource = true, onToggleSource = () => {}, isAborted }: {
  ...
  return handleGetOnlineMusicUrl({ musicInfo, quality, onToggleSource, isRefresh, allowToggleSource, isAborted }).then(({ url, quality: targetQuality, musicInfo: targetMusicInfo, isFromCache }) => {
