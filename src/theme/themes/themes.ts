...
export default [
  {
    ...
    "config": {
      "themeColors": {
        "c-primary": "rgb(250, 35, 59)",
        "c-primary-dark-100": "rgb(225,32,53)",
        "c-primary-dark-100-alpha-100": "rgba(225, 32, 53, 0.90)",
        "c-primary-alpha-100": "rgba(250, 35, 59, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(225, 32, 53, 0.80)",
        "c-primary-alpha-200": "rgba(250, 35, 59, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(225, 32, 53, 0.70)",
        "c-primary-alpha-300": "rgba(250, 35, 59, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(225, 32, 53, 0.60)",
        "c-primary-alpha-400": "rgba(250, 35, 59, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(225, 32, 53, 0.50)",
        "c-primary-alpha-500": "rgba(250, 35, 59, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(225, 32, 53, 0.40)",
        "c-primary-alpha-600": "rgba(250, 35, 59, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(225, 32, 53, 0.30)",
        "c-primary-alpha-700": "rgba(250, 35, 59, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(225, 32, 53, 0.20)",
        "c-primary-alpha-800": "rgba(250, 35, 59, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(225, 32, 53, 0.10)",
        "c-primary-alpha-900": "rgba(250, 35, 59, 0.10)",
        "c-primary-dark-200": "rgb(203,29,48)",
        "c-primary-dark-200-alpha-100": "rgba(203, 29, 48, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(203, 29, 48, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(203, 29, 48, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(203, 29, 48, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(203, 29, 48, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(203, 29, 48, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(203, 29, 48, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(203, 29, 48, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(203, 29, 48, 0.10)",
        "c-primary-dark-300": "rgb(183,26,43)",
        "c-primary-dark-300-alpha-100": "rgba(183, 26, 43, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(183, 26, 43, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(183, 26, 43, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(183, 26, 43, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(183, 26, 43, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(183, 26, 43, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(183, 26, 43, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(183, 26, 43, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(183, 26, 43, 0.10)",
        "c-primary-dark-400": "rgb(165,23,39)",
        "c-primary-dark-400-alpha-100": "rgba(165, 23, 39, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(165, 23, 39, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(165, 23, 39, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(165, 23, 39, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(165, 23, 39, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(165, 23, 39, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(165, 23, 39, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(165, 23, 39, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(165, 23, 39, 0.10)",
        "c-primary-dark-500": "rgb(149,21,35)",
        "c-primary-dark-500-alpha-100": "rgba(149, 21, 35, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(149, 21, 35, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(149, 21, 35, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(149, 21, 35, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(149, 21, 35, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(149, 21, 35, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(149, 21, 35, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(149, 21, 35, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(149, 21, 35, 0.10)",
        "c-primary-dark-600": "rgb(134,19,32)",
        "c-primary-dark-600-alpha-100": "rgba(134, 19, 32, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(134, 19, 32, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(134, 19, 32, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(134, 19, 32, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(134, 19, 32, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(134, 19, 32, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(134, 19, 32, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(134, 19, 32, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(134, 19, 32, 0.10)",
        "c-primary-dark-700": "rgb(121,17,29)",
        "c-primary-dark-700-alpha-100": "rgba(121, 17, 29, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(121, 17, 29, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(121, 17, 29, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(121, 17, 29, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(121, 17, 29, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(121, 17, 29, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(121, 17, 29, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(121, 17, 29, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(121, 17, 29, 0.10)",
        "c-primary-dark-800": "rgb(109,15,26)",
        "c-primary-dark-800-alpha-100": "rgba(109, 15, 26, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(109, 15, 26, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(109, 15, 26, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(109, 15, 26, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(109, 15, 26, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(109, 15, 26, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(109, 15, 26, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(109, 15, 26, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(109, 15, 26, 0.10)",
        "c-primary-dark-900": "rgb(98,14,23)",
        "c-primary-dark-900-alpha-100": "rgba(98, 14, 23, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(98, 14, 23, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(98, 14, 23, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(98, 14, 23, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(98, 14, 23, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(98, 14, 23, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(98, 14, 23, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(98, 14, 23, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(98, 14, 23, 0.10)",
        "c-primary-dark-1000": "rgb(88,13,21)",
        "c-primary-dark-1000-alpha-100": "rgba(88, 13, 21, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(88, 13, 21, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(88, 13, 21, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(88, 13, 21, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(88, 13, 21, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(88, 13, 21, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(88, 13, 21, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(88, 13, 21, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(88, 13, 21, 0.10)",
        "c-primary-light-100": "rgb(251,79,98)",
        "c-primary-light-100-alpha-100": "rgba(251, 79, 98, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(251, 79, 98, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(251, 79, 98, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(251, 79, 98, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(251, 79, 98, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(251, 79, 98, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(251, 79, 98, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(251, 79, 98, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(251, 79, 98, 0.10)",
        "c-primary-light-200": "rgb(252,114,129)",
        "c-primary-light-200-alpha-100": "rgba(252, 114, 129, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(252, 114, 129, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(252, 114, 129, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(252, 114, 129, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(252, 114, 129, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(252, 114, 129, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(252, 114, 129, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(252, 114, 129, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(252, 114, 129, 0.10)",
        "c-primary-light-300": "rgb(253,142,154)",
        "c-primary-light-300-alpha-100": "rgba(253, 142, 154, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(253, 142, 154, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(253, 142, 154, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(253, 142, 154, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(253, 142, 154, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(253, 142, 154, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(253, 142, 154, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(253, 142, 154, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(253, 142, 154, 0.10)",
        "c-primary-light-400": "rgb(253,165,174)",
        "c-primary-light-400-alpha-100": "rgba(253, 165, 174, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(253, 165, 174, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(253, 165, 174, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(253, 165, 174, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(253, 165, 174, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(253, 165, 174, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(253, 165, 174, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(253, 165, 174, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(253, 165, 174, 0.10)",
        "c-primary-light-500": "rgb(253,183,190)",
        "c-primary-light-500-alpha-100": "rgba(253, 183, 190, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(253, 183, 190, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(253, 183, 190, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(253, 183, 190, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(253, 183, 190, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(253, 183, 190, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(253, 183, 190, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(253, 183, 190, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(253, 183, 190, 0.10)",
        "c-primary-light-600": "rgb(253,197,203)",
        "c-primary-light-600-alpha-100": "rgba(253, 197, 203, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(253, 197, 203, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(253, 197, 203, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(253, 197, 203, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(253, 197, 203, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(253, 197, 203, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(253, 197, 203, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(253, 197, 203, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(253, 197, 203, 0.10)",
        "c-primary-light-700": "rgb(253,209,213)",
        "c-primary-light-700-alpha-100": "rgba(253, 209, 213, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(253, 209, 213, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(253, 209, 213, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(253, 209, 213, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(253, 209, 213, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(253, 209, 213, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(253, 209, 213, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(253, 209, 213, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(253, 209, 213, 0.10)",
        "c-primary-light-800": "rgb(253,218,221)",
        "c-primary-light-800-alpha-100": "rgba(253, 218, 221, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(253, 218, 221, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(253, 218, 221, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(253, 218, 221, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(253, 218, 221, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(253, 218, 221, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(253, 218, 221, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(253, 218, 221, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(253, 218, 221, 0.10)",
        "c-primary-light-900": "rgb(253,225,228)",
        "c-primary-light-900-alpha-100": "rgba(253, 225, 228, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(253, 225, 228, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(253, 225, 228, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(253, 225, 228, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(253, 225, 228, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(253, 225, 228, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(253, 225, 228, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(253, 225, 228, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(253, 225, 228, 0.10)",
      ...
      "extInfo": {
        "c-app-background": "rgba(255, 255, 255, 1)",
  ...
  },
  {
    ...
    "config": {
      "themeColors": {
        "c-primary": "rgb(250, 35, 59)",
        "c-primary-dark-100": "rgb(251,79,98)",
        "c-primary-dark-100-alpha-100": "rgba(251, 79, 98, 0.90)",
        "c-primary-alpha-100": "rgba(250, 35, 59, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(251, 79, 98, 0.80)",
        "c-primary-alpha-200": "rgba(250, 35, 59, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(251, 79, 98, 0.70)",
        "c-primary-alpha-300": "rgba(250, 35, 59, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(251, 79, 98, 0.60)",
        "c-primary-alpha-400": "rgba(250, 35, 59, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(251, 79, 98, 0.50)",
        "c-primary-alpha-500": "rgba(250, 35, 59, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(251, 79, 98, 0.40)",
        "c-primary-alpha-600": "rgba(250, 35, 59, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(251, 79, 98, 0.30)",
        "c-primary-alpha-700": "rgba(250, 35, 59, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(251, 79, 98, 0.20)",
        "c-primary-alpha-800": "rgba(250, 35, 59, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(251, 79, 98, 0.10)",
        "c-primary-alpha-900": "rgba(250, 35, 59, 0.10)",
        "c-primary-dark-200": "rgb(252,114,129)",
        "c-primary-dark-200-alpha-100": "rgba(252, 114, 129, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(252, 114, 129, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(252, 114, 129, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(252, 114, 129, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(252, 114, 129, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(252, 114, 129, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(252, 114, 129, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(252, 114, 129, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(252, 114, 129, 0.10)",
        "c-primary-dark-300": "rgb(253,142,154)",
        "c-primary-dark-300-alpha-100": "rgba(253, 142, 154, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(253, 142, 154, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(253, 142, 154, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(253, 142, 154, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(253, 142, 154, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(253, 142, 154, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(253, 142, 154, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(253, 142, 154, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(253, 142, 154, 0.10)",
        "c-primary-dark-400": "rgb(253,165,174)",
        "c-primary-dark-400-alpha-100": "rgba(253, 165, 174, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(253, 165, 174, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(253, 165, 174, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(253, 165, 174, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(253, 165, 174, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(253, 165, 174, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(253, 165, 174, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(253, 165, 174, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(253, 165, 174, 0.10)",
        "c-primary-dark-500": "rgb(253,183,190)",
        "c-primary-dark-500-alpha-100": "rgba(253, 183, 190, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(253, 183, 190, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(253, 183, 190, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(253, 183, 190, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(253, 183, 190, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(253, 183, 190, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(253, 183, 190, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(253, 183, 190, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(253, 183, 190, 0.10)",
        "c-primary-dark-600": "rgb(253,197,203)",
        "c-primary-dark-600-alpha-100": "rgba(253, 197, 203, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(253, 197, 203, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(253, 197, 203, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(253, 197, 203, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(253, 197, 203, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(253, 197, 203, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(253, 197, 203, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(253, 197, 203, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(253, 197, 203, 0.10)",
        "c-primary-dark-700": "rgb(253,209,213)",
        "c-primary-dark-700-alpha-100": "rgba(253, 209, 213, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(253, 209, 213, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(253, 209, 213, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(253, 209, 213, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(253, 209, 213, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(253, 209, 213, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(253, 209, 213, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(253, 209, 213, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(253, 209, 213, 0.10)",
        "c-primary-dark-800": "rgb(253,218,221)",
        "c-primary-dark-800-alpha-100": "rgba(253, 218, 221, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(253, 218, 221, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(253, 218, 221, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(253, 218, 221, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(253, 218, 221, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(253, 218, 221, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(253, 218, 221, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(253, 218, 221, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(253, 218, 221, 0.10)",
        "c-primary-dark-900": "rgb(253,225,228)",
        "c-primary-dark-900-alpha-100": "rgba(253, 225, 228, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(253, 225, 228, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(253, 225, 228, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(253, 225, 228, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(253, 225, 228, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(253, 225, 228, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(253, 225, 228, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(253, 225, 228, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(253, 225, 228, 0.10)",
        "c-primary-dark-1000": "rgb(253,231,233)",
        "c-primary-dark-1000-alpha-100": "rgba(253, 231, 233, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(253, 231, 233, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(253, 231, 233, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(253, 231, 233, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(253, 231, 233, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(253, 231, 233, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(253, 231, 233, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(253, 231, 233, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(253, 231, 233, 0.10)",
        "c-primary-light-100": "rgb(225,32,53)",
        "c-primary-light-100-alpha-100": "rgba(225, 32, 53, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(225, 32, 53, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(225, 32, 53, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(225, 32, 53, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(225, 32, 53, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(225, 32, 53, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(225, 32, 53, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(225, 32, 53, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(225, 32, 53, 0.10)",
        "c-primary-light-200": "rgb(203,29,48)",
        "c-primary-light-200-alpha-100": "rgba(203, 29, 48, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(203, 29, 48, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(203, 29, 48, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(203, 29, 48, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(203, 29, 48, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(203, 29, 48, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(203, 29, 48, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(203, 29, 48, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(203, 29, 48, 0.10)",
        "c-primary-light-300": "rgb(183,26,43)",
        "c-primary-light-300-alpha-100": "rgba(183, 26, 43, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(183, 26, 43, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(183, 26, 43, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(183, 26, 43, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(183, 26, 43, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(183, 26, 43, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(183, 26, 43, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(183, 26, 43, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(183, 26, 43, 0.10)",
        "c-primary-light-400": "rgb(165,23,39)",
        "c-primary-light-400-alpha-100": "rgba(165, 23, 39, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(165, 23, 39, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(165, 23, 39, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(165, 23, 39, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(165, 23, 39, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(165, 23, 39, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(165, 23, 39, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(165, 23, 39, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(165, 23, 39, 0.10)",
        "c-primary-light-500": "rgb(149,21,35)",
        "c-primary-light-500-alpha-100": "rgba(149, 21, 35, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(149, 21, 35, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(149, 21, 35, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(149, 21, 35, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(149, 21, 35, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(149, 21, 35, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(149, 21, 35, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(149, 21, 35, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(149, 21, 35, 0.10)",
        "c-primary-light-600": "rgb(134,19,32)",
        "c-primary-light-600-alpha-100": "rgba(134, 19, 32, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(134, 19, 32, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(134, 19, 32, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(134, 19, 32, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(134, 19, 32, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(134, 19, 32, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(134, 19, 32, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(134, 19, 32, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(134, 19, 32, 0.10)",
        "c-primary-light-700": "rgb(121,17,29)",
        "c-primary-light-700-alpha-100": "rgba(121, 17, 29, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(121, 17, 29, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(121, 17, 29, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(121, 17, 29, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(121, 17, 29, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(121, 17, 29, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(121, 17, 29, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(121, 17, 29, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(121, 17, 29, 0.10)",
        "c-primary-light-800": "rgb(109,15,26)",
        "c-primary-light-800-alpha-100": "rgba(109, 15, 26, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(109, 15, 26, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(109, 15, 26, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(109, 15, 26, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(109, 15, 26, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(109, 15, 26, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(109, 15, 26, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(109, 15, 26, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(109, 15, 26, 0.10)",
        "c-primary-light-900": "rgb(98,14,23)",
        "c-primary-light-900-alpha-100": "rgba(98, 14, 23, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(98, 14, 23, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(98, 14, 23, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(98, 14, 23, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(98, 14, 23, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(98, 14, 23, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(98, 14, 23, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(98, 14, 23, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(98, 14, 23, 0.10)",
        "c-primary-light-1000": "rgb(64,9,15)",
        "c-primary-light-1000-alpha-100": "rgba(64, 9, 15, 0.90)",
        "c-primary-light-1000-alpha-200": "rgba(64, 9, 15, 0.80)",
        "c-primary-light-1000-alpha-300": "rgba(64, 9, 15, 0.70)",
        "c-primary-light-1000-alpha-400": "rgba(64, 9, 15, 0.60)",
        "c-primary-light-1000-alpha-500": "rgba(64, 9, 15, 0.50)",
        "c-primary-light-1000-alpha-600": "rgba(64, 9, 15, 0.40)",
        "c-primary-light-1000-alpha-700": "rgba(64, 9, 15, 0.30)",
        "c-primary-light-1000-alpha-800": "rgba(64, 9, 15, 0.20)",
        "c-primary-light-1000-alpha-900": "rgba(64, 9, 15, 0.10)",
        "c-theme": "rgb(98,14,23)",
