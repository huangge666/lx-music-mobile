      ...
      <View style={{ height: wh.height, width: wh.width }}>
        {
          ...
          />) : (
            <TouchableOpacity style={{ ...styles.defaultPic, borderColor: theme['c-border-background'], backgroundColor: theme['c-card-background'] }} onPress={() => { setShow(true) }}>
              <Text size={13} color={theme['c-primary-font']}>{global.i18n.t('comment_show_image')}</Text>
            </TouchableOpacity>
          )
        }
      </View>
