...
export default memo(() => {
  ...
  const t = useI18n()
  const openHomePage = () => {
    void openUrl('https://github.com/huangge666/lx-music-mobile#readme')
  }
  const openIssuePage = () => {
    void openUrl('https://github.com/huangge666/lx-music-mobile/issues?q=is%3Aissue+')
  }
  const openGHReleasePage = () => {
    void openUrl('https://github.com/huangge666/lx-music-mobile/releases')
  }
  const openFAQPage = () => {
  ...
  return (
    <Section title={t('setting_about')}>
      <View style={styles.cardSection}>
        <View style={styles.part}>
          ...
          <TouchableOpacity onPress={openHomePage}>
            <Text style={textLinkStyle}>https://github.com/huangge666/lx-music-mobile</Text>
          </TouchableOpacity>
        </View>
        <View style={styles.part}>
      ...
      <View style={styles.cardSection}>
        ...
        <View style={styles.part}>
          <Text style={styles.text}><Text style={styles.boldText}>本项目没有微信公众号之类的所谓「官方账号」，也未在应用商店发布同名应用，谨防被骗！</Text></Text>
        </View>
        <View style={styles.part}>
          <Text style={styles.text}>若你使用过程中遇到<Text style={styles.boldText}>广告</Text>或者<Text style={styles.boldText}>引流</Text>信息，则表明当前运行的是「第三方修改版」。</Text>
        </View>
        <View style={styles.part}>
          <Text style={styles.text}>若升级时提示「<Text style={styles.boldText}>签名不一致</Text>」，表明新旧版本中<Text style={styles.boldText}>有一方</Text>是「<Text style={styles.boldText}>第三方修改版</Text>」。</Text>
        </View>
      </View>
      ...
      <View style={styles.footerInfo}>
        ...
        <View style={styles.part}>
          <Text style={styles.text} color={theme['c-font-label']}>By: </Text>
          <Text style={styles.text} color={theme['c-font-label']}>落雪无痕</Text>
        </View>
      </View>
    </Section>
  )
